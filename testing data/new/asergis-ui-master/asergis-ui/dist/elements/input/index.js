...
exports.FormGroup = exports.Star = exports.HelpLabel = exports.Label = exports.Textarea = exports.SearchInput = exports.FormControl = undefined;
...
var Input = function Input(_ref3) {
  var type = _ref3.type,
      ...
      error = _ref3.error,
      props = (0, _objectWithoutProperties3.default)(_ref3, ['type', 'label', 'value', 'name', 'onChange', 'placeholder', 'required', 'error']);
  ...
  return _react2.default.createElement(
    ...
    type === 'search' ? _react2.default.createElement(
      _react.Fragment,
      null,
      _react2.default.createElement(SearchInput, (0, _extends3.default)({
        type: 'text',
        'data-name': name,
        value: value,
        onChange: onChange,
      ...
      _react2.default.createElement(_box2.default, { is: _icons2.default, icon: 'search', fz: '14', className: 'search' })
